...
#     else:
#         assert False
#     core_side_prefetch = True
#     if core_side_prefetch:
#         options += {
...
#                     benchmark_config.append((benchmark, i, outdir_b))
                    
#     with ThreadPoolExecutor(max_workers=8) as executor:
#         futures = [
#             executor.submit(run, benchmark_config[i])
#             for i in range(len(benchmark_config))
#             if not cases(benchmark_config[i][0], benchmark_config[i][1] + 1)
#         ]
