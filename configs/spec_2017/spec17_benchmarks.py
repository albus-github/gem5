...
perlbench_r.cwd = run_dir('perlbench_r')
...
perlbench_s.cwd = run_dir('perlbench_s')
...
omnetpp_r.cmd = [omnetpp_r.executable]+['-c', 'General', '-r', '0']
omnetpp_r.cwd = run_dir('omnetpp_r')
...
omnetpp_s.cmd = [omnetpp_s.executable]+['-c', 'General', '-r', '0']
omnetpp_s.cwd = run_dir('omnetpp_s')
...
xalancbmk_r.cwd = run_dir('xalancbmk_r')
...
xalancbmk_s.cwd = run_dir('xalancbmk_s')
...
deepsjeng_r.cwd = run_dir('deepsjeng_r')
...
deepsjeng_s.cwd = run_dir('deepsjeng_s')
...
exchange2_r.cwd = run_dir('exchange2_r')
...
exchange2_s.cwd = run_dir('exchange2_s')
...
cactuBSSN_r.cwd = run_dir('cactuBSSN_r')
...
cactuBSSN_s.cwd = run_dir('cactuBSSN_s')
...
imagick_r.cwd = run_dir('imagick_r')
...
fotonik3d_r.cwd = run_dir('fotonik3d_r')
...
fotonik3d_s.cwd = run_dir('fotonik3d_s')
...
specrand_fr.cwd = run_dir('specrand_fr')
...
specrand_ir.cwd = run_dir('specrand_ir')