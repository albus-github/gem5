...
GEM5_DIR=/home/albus/gem5                          # Install location of gem5
SPEC_DIR=/home/albus/spec2017                  # Install location of your SPEC2006 benchmarks
...
if [[ "${BENCHMARK:0-1:1}" == "r" ]]; then
    RUN_DIR=$SPEC_DIR/benchspec/CPU/$BENCHMARK_CODE/run/run_base_refrate\_mytest-m64.0000     # Run directory for the selected SPEC benchmark
fi
if [[ "${BENCHMARK:0-1:1}" == "s" ]]; then
    RUN_DIR=$SPEC_DIR/benchspec/CPU/$BENCHMARK_CODE/run/run_base_refspeed\_mytest-m64.0000     # Run directory for the selected SPEC benchmark
fi
# RUN_DIR=$SPEC_DIR/benchspec/CPU/$BENCHMARK_CODE/build/build_base\_mytest-m64.0000     # Run directory for the selected SPEC benchmark
